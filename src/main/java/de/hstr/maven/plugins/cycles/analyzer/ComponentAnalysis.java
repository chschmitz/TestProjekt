...
import de.hstr.maven.plugins.cycles.graph.GraphBuilder;
import de.hstr.maven.plugins.cycles.graph.NameFilter;
import de.hstr.maven.plugins.cycles.graph.StronglyConnectedComponents;
import de.hstr.maven.plugins.cycles.graph.SubgraphUtils;
